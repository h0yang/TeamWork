...
<template>
  <div class="container">
    <div id="title">线性回归算法,K均值聚类算法及梯度增强算法的实现</div>
    <h2>数据集选择</h2>
    <div class="content">
      ...
      <div class="content">
        <el-radio-group v-model="selectedModel">
          <el-radio label="GRADIENTBOOSTING">GradientBoosting</el-radio>
          <el-radio label="KMEANS">KMeansCluster</el-radio>
          <el-radio label="LINEAR">LinearRegression</el-radio>
        </el-radio-group>
      </div>
      ...
      <div class="content1">
        <el-radio-group v-model="selectedmethod">
          <el-radio label="RAMDOM">random</el-radio>
    ...
    <button @click="navigatorToapp">Back</button>
  </div>
</template>
<style scoped>
.container {
...
export default {
  ...
  methods: {
    sendData() {
      ...
      axios.post('http://127.0.0.1:5000/get_data3', data, {
        headers: {
