...
<template>
  <div class="container">
    <div id="title">逻辑回归算法,朴素贝叶斯算法及降维算法的实现</div>
    <h2>数据集选择</h2>
    <div class="content">
      ...
      <div class="content">
        <el-radio-group v-model="selectedModel">
          <el-radio label="LOGISTIC">LogisticRegressionModel</el-radio>
          <el-radio label="NAIVEBAYES">NaiveBayesModel</el-radio>
          <el-radio label="PCA">DimensionalityReduction</el-radio>
        </el-radio-group>
      </div>
...
export default {
  ...
  methods: {
    sendData() {
      ...
      axios.post('http://127.0.0.1:5000/get_data2', data, {
        headers: {
