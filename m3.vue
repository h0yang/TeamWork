    ...
    <div class="content">
      ...
      <div class="content">
        <el-radio-group v-model="selectedModel">
          <el-radio label="DECISIONTREE">DecisionTree</el-radio>
          <el-radio label="KNN">KNN</el-radio>
        </el-radio-group>
      </div>
...
export default {
  ...
  methods: {
    sendData() {
      ...
      axios.post('http://127.0.0.1:5000/get_data1', data, {
        headers: {
